    ...
    <div class="w3-twothird w3-container" style="margin-left: 44px; margin-top: 18px; width: 78%;">
      <h1 class="w3-text-teal" style="text-align: center;">자기소개서 목록</h1>
		...
		<tr>
			...
			<th style="width: 15%; font-weight: bold; background-color:#999696;">작성자</th>
			<th style="width: 15%; font-weight: bold; background-color:#999696;">작성일</th>
		</tr>
		<c:if test="${totCnt > 0 }">
			<c:forEach var="Seboard" items="${list }">
				<tr>
					...
					<td style="width: 15%; font-weight: bold; background-color: #ddd;">${Seboard.m_nickname}</td>
					<td style="width: 15%; font-weight: bold; background-color: #ddd;">${Seboard.s_regdate}</td>
				</tr>
