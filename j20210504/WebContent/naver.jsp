	...
	<div id="wrapper">
		...
		<div style="width: 90%; margin: 0 auto; margin-top:30px; color:black; border: 2px solid #4d6083;">
			<div style="margin: 0 auto; margin:35px 0 70px 0; text-align: center;">
				...
				<img src="images/naver.png" width="500" height="200" align=center/>
			<table border=1>
			<tr>
			<td width="100" height="50"  align=center >위치</td>
			<td width="300" height="50">경기 성남시 분당구 정자동 178-1 NAVER 그린팩토리</td>
			<td width="400" height="50" align=center>
			<a href="https://www.navercorp.com/">네이버 채용사이트 바로가기</a>
			</td></tr></table>
				<br><br>
				<table border=1 >
					...
					<td width="300" height="50">포털,컨텐츠,커뮤니티</td>
					<td width="100" height="50"><h2>사원수</h2></td>
					<td width="300" height="50">2963명</td>
					</tr>
					<tr  align=center >
					<td width="100" height="50"><h2>기업구분</h2></td>
					<td width="300" height="50">중견기업</td>
					<td width="100" height="50"><h2>설립연도</h2></td>
					<td width="300" height="50">1999년</td>
					</tr>
					<tr  align=center >
					<td width="100" height="50"><h2>대표자</h2></td>
					<td width="300" height="50">한성숙</td>
					<td width="100" height="50"><h2>매출액</h2></td>
					<td width="300" height="50">4조 226억원</td>
					</tr>
					<tr  align=center >
					<td width="100" height="50"><h2>자본금</h2></td>
					<td width="300" height="50">164억 8천만원</td>
