...
<div class="w3-main" style="margin-left:250px;"> 
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container" style="margin-left: 44px; margin-top: 18px; width: 80%;">
      ...
      <h1 class="w3-text-teal" style="text-align: center;">자기소개서 수정</h1>
      	<table border="1" style="text-align: center; background-color:#ddd; margin: 0 auto; width: 100%;">
			<tr>
			<td>공개여부</td>
			<td>
				<c:if test="${Seboard.s_type == 0 }">
			...
			<tr><td>내용작성</td><td><pre><textarea name="s_content" id="s_content" maxlength="4000" style="height:350px; width: 90%;" required="required" onKeyUp="javascript:fnChkByte(this,'4000')">${Seboard.s_content }</textarea></pre>
			<br>
