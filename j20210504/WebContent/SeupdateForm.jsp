	...
	<div id="wrapper">
		...
		<div style="width: 90%; margin: 0 auto; margin-top:30px; color:black; border: 2px solid #4d6083;">
			<div style="margin: 0 auto; margin:35px 0 70px 0; text-align: center;">
				<form action="SeupdatePro.do?pageNum=${pageNum}" method="post">
		<input type="hidden" name="m_nickname" value="${m_nickname }">
		<input type="hidden" name="m_num" value="${m_num }">
<%-- 		<input type="hidden" name="s_type" value="${s_type }"> --%>
		<input type="hidden" name="s_idx" value="${Seboard.s_idx }">
	
		<table border="1" style="text-align: center; background-color:#838ea3; margin: 0 auto; width: 70%;">
			<caption><h2>자기소개서 수정</h2></caption>
			<tr>
			<td>공개여부</td><td><input type="checkbox" name="s_type" value="1" onclick="checkOnlyOne(this)">공개
							  <input type="checkbox" name="s_type" value="0" onclick="checkOnlyOne(this)">비공개</td>
			</tr>
			<tr><td>회사이름</td><td><pre><input type="text" name="s_companyname" maxlength="50" style="height:40px; width: 90%; margin-bottom: 20px;" required="required" value="${Seboard.s_companyname }"></pre></td></tr>
			<tr><td>내용작성</td><td><pre><textarea name="s_content" id="s_content" maxlength="4000" style="height:350px;" required="required" onKeyUp="javascript:fnChkByte(this,'4000')">${Seboard.s_content }</textarea></pre>
			<br>
			<span id="byteInfo">0</span>/4000bytes</td></tr>
			<table style="margin: 0 auto;">
				<tr><td colspan="2"><input type="submit" value="수정완료" class="btn">
					</td></tr>
			</table>
		</table>
</form>
