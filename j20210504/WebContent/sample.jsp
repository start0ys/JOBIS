...
<body>
	...
	<div style="width: 90%; margin: 0 auto; margin-top:30px; text-align: center; color:black; background-color: yellow; ">
		여기에 기능 구현하신거 넣어주시고 꾸며주시면되요<p> 
		이 글 부분 지워주시고 div부분의  background-color: yellow; 이 부분도 지워주세요 <p>
		여기에 기능 구현하신거 넣어주시고 꾸며주시면되요<p> 
		이 글 부분 지워주시고 div부분의  background-color: yellow; 이 부분도 지워주세요 <p>
		여기에 기능 구현하신거 넣어주시고 꾸며주시면되요<p> 
		이 글 부분 지워주시고 div부분의  background-color: yellow; 이 부분도 지워주세요 <p>
