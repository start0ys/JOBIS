...
<div class="w3-main" style="margin-left:250px;"> 
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container" style="margin-left: 44px; margin-top: 18px; width: 78%;">
      <h1 class="w3-text-teal" style="text-align: center;">${m_nickname}님의 자기소개서</h1>
      	<table  style="text-align: center;margin: 0 auto; width: 100%;"> 
		<tr align="center">
         	<!--  -->
         	<th style="width: 20%;background-color:#999696;">공개여부</th>
         	<!--  -->
			<th style="width: 35%; font-weight: bold; font-size: 18px;background-color:#999696;">회사이름</th>
			...
			<c:forEach var="Seboard" items="${list }">
				<tr>
					...
					<c:if test="${Seboard.s_type == 0 }">
						<td style="width: 15%; background-color: #ddd;">비공개</td>
					</c:if>
					<c:if test="${Seboard.s_type == 1 }">
						<td style="width: 15%; background-color: #ddd;">공개</td>
					</c:if>
					<!--  -->
					<td style="width: 55%; font-weight: bold; font-size: 18px;background-color: #ddd;">
						 <a href='Secontent.do?s_idx=${Seboard.s_idx}&pageNum=${currentPage}' style="text-decoration: none;">
		...
		<!--  -->
			<script type="text/javascript">
				alert("작성한 자기소개서가 없습니다. 작성하시겠습니까?");
